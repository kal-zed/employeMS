...
void displayEmployeesBySalaryRange(double lowerBound, double upperBound) {
    bool found = false;
    cout << "Employees with salary between " << lowerBound << " birr and " << upperBound << " birr:\n";
    for (int i = 0; i < employeeCount; i++) {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                cout << "Enter department name: "<<"use CS for computer science,IS for information system,IT for information technology,INFOSA for information science";
